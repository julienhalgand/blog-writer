...
$router->post('/commentary/create',['flash','isAuthenticated'] ,'Commentary.create' ,'Create commentary');
$router->post('/report/create',['flash','isAuthenticated'] ,'Report.create' ,'Create report');
...
$router->get('/session/signout',['flash','isAuthenticated'] ,'User.destroySession' ,'Session user');
...
$router->get('/reports/:page',['flash','isAuthenticated','isAdmin'] , 'Commentary.indexReports' , "Index reports page")->with('page', '[0-9]+');
